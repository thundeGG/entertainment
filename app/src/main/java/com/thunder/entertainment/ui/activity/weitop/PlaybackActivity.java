...
//    }
    ...
    public void onUploadVideoSuccess(String fileName) {
        ...
        MessageEvent<WeiTopModel> modelMessageEvent =new MessageEvent<>();
        modelMessageEvent.setData(weiTopModel);
        modelMessageEvent.setTag("更新微头条列表");
        EventBus.getDefault().post(modelMessageEvent);
        finish();
