...
/**
 * Created by beibeizhu on 17/8/3.
 */
...
public class Auth {
    ...
    public String signWithData(byte[] data) throws UnsupportedEncodingException {
        String s = UrlSafeBase64.encodeToString(data);
        return sign(StringUtils.utf8Bytes(s)) + ":" + s;
    }

    public String signWithData(String data) throws UnsupportedEncodingException {
     ...
     * @return
     */
    public String signRequest(String urlString, byte[] body, String contentType) throws UnsupportedEncodingException {
     ...
     * @return
     */
    public boolean isValidCallback(String originAuthorization, String url, byte[] body, String contentType) throws UnsupportedEncodingException {
     ...
     * @return
     */
    public String privateDownloadUrl(String baseUrl) throws UnsupportedEncodingException {
     ...
     * @return
     */
    public String privateDownloadUrl(String baseUrl, long expires) throws UnsupportedEncodingException {
        long deadline = System.currentTimeMillis() / 1000 + expires;
        return privateDownloadUrlWithDeadline(baseUrl, deadline);
    }

    String privateDownloadUrlWithDeadline(String baseUrl, long deadline) throws UnsupportedEncodingException {
     ...
     * @return 生成的上传token
     */
    public String uploadToken(String bucket) throws UnsupportedEncodingException {
     ...
     * @return 生成的上传token
     */
    public String uploadToken(String bucket, String key) throws UnsupportedEncodingException {
     ...
     * @return 生成的上传token
     */
    public String uploadToken(String bucket, String key, long expires, StringMap policy) throws UnsupportedEncodingException {
     ...
     * @return 生成的上传token
     */
    public String uploadToken(String bucket, String key, long expires, StringMap policy, boolean strict) throws UnsupportedEncodingException {
        long deadline = System.currentTimeMillis() / 1000 + expires;
        return uploadTokenWithDeadline(bucket, key, deadline, policy, strict);
    }

    public String uploadTokenWithDeadline(String bucket, String key, long deadline, StringMap policy, boolean strict) throws UnsupportedEncodingException {
        // TODO   UpHosts Global
        String scope = bucket;
        if (key != null) {
            scope = bucket + ":" + key;
    ...
    public StringMap authorization(String url, byte[] body, String contentType) throws UnsupportedEncodingException {
        String authorization = "QBox " + signRequest(url, body, contentType);
        return new StringMap().put("Authorization", authorization);
    }

    public StringMap authorization(String url) throws UnsupportedEncodingException {
     ...
     * @return
     */
    public String signRequestV2(String urlString, String method, byte[] body, String contentType) throws UnsupportedEncodingException {
        URI uri = URI.create(urlString);
    ...
    public StringMap authorizationV2(String url, String method, byte[] body, String contentType) throws UnsupportedEncodingException {
        String authorization = "Qiniu " + signRequestV2(url, method, body, contentType);
        return new StringMap().put("Authorization", authorization);
    }

    public StringMap authorizationV2(String url) throws UnsupportedEncodingException {
